...
export function buildPrompt(issue: IssueRef, ctx: BuildPromptContext): string {
  ...
  return [
    ...
    '- After committing your changes, end your final message with a unified diff',
    '  of every change you made, wrapped in literal <patch> and </patch> tags:',
    '    <patch>',
    '    diff --git a/... b/...',
    '    ...',
    '    </patch>',
    '  Emit nothing inside the tags except the unified diff. Omit the block',
    '  entirely when you are emitting a SKIP line.',
    '',
    'Test guidance:',
    testGuidance,
    '',
